...
cred_var=read.table("/stk05236/lmm/all_loci/07_cred_var/all_cred_var_99_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE)
...
CADD_wo_filter=read.table("/stk05236/lmm/all_loci/cadd_lmm/results_no_cutoff/cadd_in_gws_var_ks.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
NEPTUNE_glo=fread("/stk05236/lmm/all_loci/neptune/cred_var_with_nephQTL_glomerular_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
NEPTUNE_tub=fread("/stk05236/lmm/all_loci/neptune/cred_var_with_nephQTL_tubulointerstitial_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
NEPTUNE_tub=NEPTUNE_tub[which(!(is.na(NEPTUNE_tub$Approved.symbol))),]
susztak_glo=fread("/stk05236/lmm/all_loci/susztak/cred_var_with_susztak_glomerular_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
susztak_tub=fread("/stk05236/lmm/all_loci/susztak/cred_var_with_susztak_tubulointerstitial_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)


GTEx_eQTL=fread("/stk05236/lmm/all_loci/gtex_eqtl/all_cred_var_wakefield_with_gtex_right_gene_name_no_dup_kidney_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
GTEx_sQTL=fread("/stk05236/lmm/all_loci/gtex_sqtl/all_cred_var_wakefield_with_gtex_sqtl_right_gene_name_no_dup_kidney_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
gtex_without_kidney=fread("/stk05236/lmm/all_loci/gtex_eqtl/all_cred_var_wakefield_with_gtex_right_gene_name_no_dup_without_kidney_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
sqtl_without_kidney=fread("/stk05236/lmm/all_loci/gtex_sqtl/all_cred_var_wakefield_with_gtex_sqtl_right_gene_name_no_dup_without_kidney_egfr_lowering.txt",  header = TRUE, sep = "\t", stringsAsFactors = FALSE,  data.table = FALSE)
...
DM_decline = read.table("/stk05236/GPS_App/DM_decline_effects_withStanzickId.txt", header=TRUE, sep = "\t", stringsAsFactors=FALSE)
...
save.image(file="/stk05236/GPS_App/050922/data/workspace.RData")